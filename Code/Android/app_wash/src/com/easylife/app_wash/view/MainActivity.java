...
public class MainActivity extends CustomActivity {
	...
	BaseFragment mCartFragment, mHomeFragment, mSpaceFragment, mMoreFragment;
	...
	protected void onStart() {
		...
		mImageActivity.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				// if (mUser.isVip()) {
				repaceFragment(getWashingCartFragment());
				setFocuseStatus();
				// } else {
	...
	private BaseFragment getHomeFragment() {
		...
		mHomeFragment = new WashingHomeFragment();
		// }
		return mHomeFragment;
	}

	private BaseFragment getWashingCartFragment() {
		// if (mActivityFragment == null) {
		mCartFragment = new WashingCartFragment();
		// }
